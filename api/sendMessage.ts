...
- **Citations**: When you use Google Search to answer, you MUST cite your sources.
    ...
    4. The JSON must be an array of objects. Each object needs a "number" (as a number, e.g., 1) and a "sources" array. Each source object needs a "url" and "title" from the search results.
