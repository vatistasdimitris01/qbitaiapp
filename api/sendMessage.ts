...
- **Maps Listing**: When you use the Google Maps tool, the user interface will automatically display a card with a list of the places you found. Therefore, you **SHOULD NOT** repeat this list in your main text response. You can summarize what you found (e.g., "I found 3 great cafes nearby.") but do not provide a detailed list with names, as the UI will render it.
