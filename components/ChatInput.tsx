                ...
                <form onSubmit={handleSubmit} className="relative w-full">
                    <div className="relative flex items-end w-full bg-card border border-default shadow-lg transition-all duration-300 rounded-2xl sm:rounded-full py-1 pl-2 pr-1.5">
                        <button
                            ...
                            className="inline-flex items-center justify-center h-9 w-9 rounded-full hover:bg-token-surface-secondary text-muted disabled:opacity-60 transition-colors mr-1"
                            disabled={isLoading}
                        >
