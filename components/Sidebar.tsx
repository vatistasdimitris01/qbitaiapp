  ...
  return (
    <div className="flex-col h-full bg-sidebar border-r border-sidebar z-50 fixed inset-y-0 left-0 w-16 transition-all duration-300 hidden md:flex">
        ...
        <div className="flex-1 flex flex-col overflow-hidden items-center">
            <div className="p-3">
                <button onClick={onNewChat} className="w-full flex items-center justify-center gap-3 p-3 text-sidebar-muted-fg hover:bg-sidebar-active hover:text-sidebar-fg rounded-lg transition-colors" title={t('newChat')}>
        ...
        <div className="p-3">
            <button onClick={onOpenSettings} className="w-full flex items-center justify-center gap-3 p-3 text-sidebar-muted-fg hover:bg-sidebar-active hover:text-sidebar-fg rounded-lg" title={t('settings')}>
