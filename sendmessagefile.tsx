...
- **STRICT "CODE-ONLY" RULE**: When using \`autorun\`, your response MUST consist ONLY of the code block. No greetings, no explanations, no text before or after it. The UI handles user feedback.
