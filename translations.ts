  ...
  el: {
    ...
    settings: {
      ...
      api: {
        ...
        description: 'Χρησιμοποιήστε το δωρεάν API μας για ερωτήματα AI. Προσαρμόστε τη συμπεριφορά με δικές σας οδηγίες, παρέχετε εργαλεία για κλήση συναρτήσεων ή χρησιμοποιήστε την προεπιλεγμένη αναζήτηση ιστού.',
        endpoint: 'Endpoint του API',
        basicTitle: 'Βασικά Ερωτήματα & Προσαρμοσμένες Οδηγίες',
        basicDescription: 'Κάντε ένα απλό αίτημα ή προσθέστε μια `userInstruction` για να καθοδηγήσετε τον τόνο, το στυλ ή την εργασία της AI. Η οδηγία σας προστίθεται πάνω από την βασική προσωπικότητα.',
        toolsTitle: 'Για προχωρημένους: Χρήση Εργαλείων (Κλήση Συναρτήσεων)',
        toolsDescription: 'Παρέχετε προσαρμοσμένους ορισμούς εργαλείων για να λαμβάνετε δομημένο JSON από την AI για την κλήση των δικών σας συναρτήσεων ή API. Αυτό επιτρέπει ισχυρές ενσωματώσεις.',
  ...
  es: {
    ...
    settings: {
      ...
      api: {
        ...
        description: 'Utilice nuestro endpoint de API gratuito para consultas de IA. Personalice el comportamiento con sus propias instrucciones, proporcione herramientas para llamadas de funciones o utilice la búsqueda web predeterminada.',
        endpoint: 'Endpoint de la API',
        basicTitle: 'Consultas Básicas e Instrucciones Personalizadas',
        basicDescription: 'Realice una solicitud simple o agregue una `userInstruction` para guiar el tono, estilo o tarea de la IA. Su instrucción se agrega sobre la personalidad base.',
        toolsTitle: 'Avanzado: Uso de Herramientas (Llamada de Funciones)',
        toolsDescription: 'Proporcione definiciones de herramientas personalizadas para que la IA devuelva JSON estructurado para llamar a sus propias funciones o API. Esto permite integraciones potentes.',
  ...
  fr: {
    ...
    settings: {
      ...
      api: {
        ...
        description: "Utilisez notre point de terminaison d'API gratuit pour les requêtes IA. Personnalisez le comportement avec vos propres instructions, fournissez des outils pour les appels de fonction ou utilisez la recherche web par défaut.",
        endpoint: "Point de terminaison de l'API",
        basicTitle: 'Requêtes de Base & Instructions Personnalisées',
        basicDescription: "Faites une simple requête ou ajoutez une `userInstruction` pour guider le ton, le style ou la tâche de l'IA. Votre instruction est ajoutée par-dessus la personnalité de base.",
        toolsTitle: 'Avancé : Utilisation des Outils (Appel de Fonctions)',
        toolsDescription: "Fournissez des définitions d'outils personnalisées pour que l'IA renvoie du JSON structuré afin d'appeler vos propres fonctions ou API. Cela permet des intégrations puissantes.",
  ...
  de: {
    ...
    settings: {
      ...
      api: {
        ...
        description: 'Nutzen Sie unseren kostenlosen API-Endpunkt für KI-Anfragen. Passen Sie das Verhalten mit Ihren eigenen Anweisungen an, stellen Sie Tools für Funktionsaufrufe bereit oder verwenden Sie die Standard-Websuche.',
        endpoint: 'API-Endpunkt',
        basicTitle: 'Grundlegende Abfragen & benutzerdefinierte Anweisungen',
        basicDescription: 'Stellen Sie eine einfache Anfrage oder fügen Sie eine `userInstruction` hinzu, um den Ton, den Stil oder die Aufgabe der KI zu steuern. Ihre Anweisung wird über die Basispersönlichkeit gelegt.',
        toolsTitle: 'Erweitert: Verwendung von Tools (Funktionsaufrufe)',
        toolsDescription: 'Stellen Sie benutzerdefinierte Tool-Definitionen bereit, damit die KI strukturiertes JSON zum Aufrufen Ihrer eigenen Funktionen oder APIs zurückgibt. Dies ermöglicht leistungsstarke Integrationen.',
